...
def main():
    ...
    genotype_nodes = genotypes.WAPC_nodes2
    print('---------Genotype---------')
    logging.info(genotype)
    print('--------------------------')

    model = Network(args.init_channels, CLASSES, args.layers, args.auxiliary, genotype,genotype_nodes)
    if args.parallel:
    ...
    traindir = os.path.join(data_dir, 'data_256')
    validdir = os.path.join(data_dir, 'val_256')
